...
type BGPConfigurationInterface interface {
	Create(ctx context.Context, bGPConfiguration *projectcalico.BGPConfiguration, opts v1.CreateOptions) (*projectcalico.BGPConfiguration, error)
	Update(ctx context.Context, bGPConfiguration *projectcalico.BGPConfiguration, opts v1.UpdateOptions) (*projectcalico.BGPConfiguration, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*projectcalico.BGPConfiguration, error)
	List(ctx context.Context, opts v1.ListOptions) (*projectcalico.BGPConfigurationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.BGPConfiguration, err error)
...
func (c *bGPConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *projectcalico.BGPConfiguration, err error) {
...
func (c *bGPConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *projectcalico.BGPConfigurationList, err error) {
...
func (c *bGPConfigurations) Create(ctx context.Context, bGPConfiguration *projectcalico.BGPConfiguration, opts v1.CreateOptions) (result *projectcalico.BGPConfiguration, err error) {
	result = &projectcalico.BGPConfiguration{}
	err = c.client.Post().
		Resource("bgpconfigurations").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *bGPConfigurations) Update(ctx context.Context, bGPConfiguration *projectcalico.BGPConfiguration, opts v1.UpdateOptions) (result *projectcalico.BGPConfiguration, err error) {
	result = &projectcalico.BGPConfiguration{}
	err = c.client.Put().
		Resource("bgpconfigurations").
...
func (c *bGPConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.BGPConfiguration, err error) {
	result = &projectcalico.BGPConfiguration{}

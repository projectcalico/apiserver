...
func (c *FakeGlobalNetworkPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *projectcalico.GlobalNetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalNetworkPolicies) List(ctx context.Context, opts v1.ListOptions) (result *projectcalico.GlobalNetworkPolicyList, err error) {
	obj, err := c.Fake.
	...
	list := &projectcalico.GlobalNetworkPolicyList{ListMeta: obj.(*projectcalico.GlobalNetworkPolicyList).ListMeta}
...
func (c *FakeGlobalNetworkPolicies) Create(ctx context.Context, globalNetworkPolicy *projectcalico.GlobalNetworkPolicy, opts v1.CreateOptions) (result *projectcalico.GlobalNetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalNetworkPolicies) Update(ctx context.Context, globalNetworkPolicy *projectcalico.GlobalNetworkPolicy, opts v1.UpdateOptions) (result *projectcalico.GlobalNetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalNetworkPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.GlobalNetworkPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(globalnetworkpoliciesResource, name, pt, data, subresources...), &projectcalico.GlobalNetworkPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*projectcalico.GlobalNetworkPolicy), err

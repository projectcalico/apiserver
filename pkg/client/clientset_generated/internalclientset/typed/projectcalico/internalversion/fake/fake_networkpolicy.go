...
func (c *FakeNetworkPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *projectcalico.NetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkPolicies) List(ctx context.Context, opts v1.ListOptions) (result *projectcalico.NetworkPolicyList, err error) {
	obj, err := c.Fake.
	...
	list := &projectcalico.NetworkPolicyList{ListMeta: obj.(*projectcalico.NetworkPolicyList).ListMeta}
...
func (c *FakeNetworkPolicies) Create(ctx context.Context, networkPolicy *projectcalico.NetworkPolicy, opts v1.CreateOptions) (result *projectcalico.NetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkPolicies) Update(ctx context.Context, networkPolicy *projectcalico.NetworkPolicy, opts v1.UpdateOptions) (result *projectcalico.NetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.NetworkPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkpoliciesResource, c.ns, name, pt, data, subresources...), &projectcalico.NetworkPolicy{})

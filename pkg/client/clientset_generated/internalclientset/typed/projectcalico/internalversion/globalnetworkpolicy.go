...
type GlobalNetworkPolicyInterface interface {
	Create(ctx context.Context, globalNetworkPolicy *projectcalico.GlobalNetworkPolicy, opts v1.CreateOptions) (*projectcalico.GlobalNetworkPolicy, error)
	Update(ctx context.Context, globalNetworkPolicy *projectcalico.GlobalNetworkPolicy, opts v1.UpdateOptions) (*projectcalico.GlobalNetworkPolicy, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*projectcalico.GlobalNetworkPolicy, error)
	List(ctx context.Context, opts v1.ListOptions) (*projectcalico.GlobalNetworkPolicyList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.GlobalNetworkPolicy, err error)
...
func (c *globalNetworkPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *projectcalico.GlobalNetworkPolicy, err error) {
	result = &projectcalico.GlobalNetworkPolicy{}
	err = c.client.Get().
...
func (c *globalNetworkPolicies) List(ctx context.Context, opts v1.ListOptions) (result *projectcalico.GlobalNetworkPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &projectcalico.GlobalNetworkPolicyList{}
	err = c.client.Get().
		Resource("globalnetworkpolicies").
...
func (c *globalNetworkPolicies) Create(ctx context.Context, globalNetworkPolicy *projectcalico.GlobalNetworkPolicy, opts v1.CreateOptions) (result *projectcalico.GlobalNetworkPolicy, err error) {
	result = &projectcalico.GlobalNetworkPolicy{}
	err = c.client.Post().
		Resource("globalnetworkpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *globalNetworkPolicies) Update(ctx context.Context, globalNetworkPolicy *projectcalico.GlobalNetworkPolicy, opts v1.UpdateOptions) (result *projectcalico.GlobalNetworkPolicy, err error) {
	result = &projectcalico.GlobalNetworkPolicy{}
	err = c.client.Put().
		Resource("globalnetworkpolicies").
...
func (c *globalNetworkPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.GlobalNetworkPolicy, err error) {
	result = &projectcalico.GlobalNetworkPolicy{}

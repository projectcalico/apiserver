...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	apiserver, ok := obj.(*calico.CalicoNodeStatus)
	if !ok {
...
// MatchCalicoNodeStatus is the filter used by the generic etcd backend to watch events
// from etcd to clients of the apiserver only interested in specific labels/fields.
func MatchCalicoNodeStatus(label labels.Selector, field fields.Selector) storage.SelectionPredicate {
...
// CalicoNodeStatusToSelectableFields returns a field set that represents the object.
func CalicoNodeStatusToSelectableFields(obj *calico.CalicoNodeStatus) fields.Set {
